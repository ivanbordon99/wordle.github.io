...
let palabraActual = [];
let diccionario = ['APPLE', 'ACTOR', 'ARBOL', 'HASTA'];
let tecla;
let count = 0;
let hayLetra = false;
...
function pintar() {
    ...
    for (let j = 0; j < 5; j++) {
        ...
        if (matriz[intento][j] === 2) {
            ...
            ficha.style.backgroundColor = "#fed330";
            ficha.style.borderColor = "#fed330";
            ficha.style.color = "white";
        ...
        if (matriz[intento][j] === 3) {
            ...
            ficha.style.backgroundColor = "#bdc3c7";
            ficha.style.borderColor = "#bdc3c7";
            ficha.style.color = "white";
